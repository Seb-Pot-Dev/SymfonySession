...
class CourseController extends AbstractController
{
    ...
    public function index(Security $security, ManagerRegistry $doctrine, Course $course = null, Request $request): Response
    ...
    public function remove(Security $security, EntityManagerInterface $entityManager, Course $course = null): Response
    {
        $user=$security->getUser();
        if($user){
            if($course){
    ...
    public function show(Security $security, Course $course): Response
